...
(function($) {
  ...
  var temp_map_config = {
          'map' : {
            ...
            'bounds' : {
              'position' : {
                'top_left_coords' : {'lat': 40.712216, 'lng': -74.22655},
                'bottom_right_coords' : {'lat': 40.773941, 'lng': -74.12544}
              },
              'zoom' : {
                'min': 10,
                'max' : 18
          ...
          'polygons' : [
            {
              'polygon' : {
                ...
                'name' : 'asdf',
                'points' : [
                  {'lat' : 40.7126, 'lng': -74.2264},
                  {'lat' : 40.7124, 'lng': -74.2265},
                  {'lat' : 40.7123, 'lng': -74.2266},
                ]
              }
            }
          ],
